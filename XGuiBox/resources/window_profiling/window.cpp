...
// Инициализация FFmpeg и текстуры
...
void window_profiling::create_window() 
{
    ...
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindow(_T("Window"), _T("DirectX 9 Fish Eye Effect"), types_of_window::POPUP, 0, 0, this->window_size.x, this->window_size.y, NULL, NULL, wc.hInstance, NULL);
