...
namespace ImGui
{
    ...
    bool                    AnimatedText(const char* fmt, float speed);
    // Widgets: Text
    ...
    IMGUI_API bool          Checkmark(const char* label);
    ...
    IMGUI_API bool          SliderScalarForProgress(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
...
struct ImDrawList
{
    ...
    bool            AddAnimatedText(float speed, const ImVec2& pos, ImU32 col, const char* text_begin);
